...
TIMEOUT=10
	...
	local status
	# bluetoothctl prints the powered state as 'Powered: yes' or 'Powered: no'
	# be robust and parse the value directly
	status=$(bluetoothctl show | awk -F': ' '/Powered/ {print $2; exit}')
